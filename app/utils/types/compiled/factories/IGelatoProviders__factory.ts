...
import type { IGelatoProviders } from '../IGelatoProviders'

export class IGelatoProviders__factory {
  static connect(address: string, signerOrProvider: Signer | Provider): IGelatoProviders {
