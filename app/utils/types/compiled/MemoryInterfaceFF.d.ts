...
interface MemoryInterfaceFFInterface extends ethers.utils.Interface {
  functions: {
...
export class MemoryInterfaceFF extends Contract {
  ...
  interface: MemoryInterfaceFFInterface
