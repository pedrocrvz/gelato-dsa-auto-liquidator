...
interface IInstaPoolResolverInterface extends ethers.utils.Interface {
  functions: {
...
export class IInstaPoolResolver extends Contract {
  ...
  interface: IInstaPoolResolverInterface
