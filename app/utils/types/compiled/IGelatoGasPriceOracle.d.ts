...
interface IGelatoGasPriceOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class IGelatoGasPriceOracle extends Contract {
  ...
  interface: IGelatoGasPriceOracleInterface
