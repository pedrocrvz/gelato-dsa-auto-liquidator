...
interface ConnectorAutoLiquidateInterface extends ethers.utils.Interface {
  functions: {
    'connectorID()': FunctionFragment
    'getDataAndCastAutoLiquidation(uint256,address)': FunctionFragment
    'name()': FunctionFragment
  }

  encodeFunctionData(functionFragment: 'connectorID', values?: undefined): string
  encodeFunctionData(functionFragment: 'getDataAndCastAutoLiquidation', values: [BigNumberish, string]): string
...
export class ConnectorAutoLiquidate extends Contract {
  ...
  interface: ConnectorAutoLiquidateInterface
  ...
  functions: {
    ...
    'getDataAndCastAutoLiquidation(uint256,address)'(
      _vaultId: BigNumberish,
      _colToken: string,
      overrides?: PayableOverrides,
    ): Promise<ContractTransaction>
  ...
  callStatic: {
    ...
    getDataAndCastAutoLiquidation(_vaultId: BigNumberish, _colToken: string, overrides?: CallOverrides): Promise<void>
