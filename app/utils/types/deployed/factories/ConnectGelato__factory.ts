...
import type { ConnectGelato } from '../ConnectGelato'

export class ConnectGelato__factory {
  static connect(address: string, signerOrProvider: Signer | Provider): ConnectGelato {
