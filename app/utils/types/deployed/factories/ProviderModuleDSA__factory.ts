...
import type { ProviderModuleDSA } from '../ProviderModuleDSA'

export class ProviderModuleDSA__factory {
  static connect(address: string, signerOrProvider: Signer | Provider): ProviderModuleDSA {
