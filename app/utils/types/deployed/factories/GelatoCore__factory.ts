...
import type { GelatoCore } from '../GelatoCore'

export class GelatoCore__factory {
  static connect(address: string, signerOrProvider: Signer | Provider): GelatoCore {
    return new Contract(address, _abi, signerOrProvider) as GelatoCore
  }
}
