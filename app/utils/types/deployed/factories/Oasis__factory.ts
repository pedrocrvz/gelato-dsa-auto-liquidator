...
export class Oasis__factory {
  static connect(address: string, signerOrProvider: Signer | Provider): Oasis {
    return new Contract(address, _abi, signerOrProvider) as Oasis
  }
}
